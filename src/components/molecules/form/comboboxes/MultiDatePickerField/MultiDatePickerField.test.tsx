...
describe('MultiDatePickerField', () => {
  describe('Semantics', () => {
    ...
    it('displays multi-value', () => {
      ...
      expect(combobox).toHaveTextContent('3/4/2023, 3/5/2023')
    })
  ...
  describe('Interaction', () => {
    it('onChange fires on date selection', async () => {
      ...
      render(<FieldWithHooks value={[startOfDay(defaultTestDate)]} onChange={onChange} />)
      const combobox = screen.getByRole('combobox')
      ...
      await act(async () => {
        fireEvent.click(screen.getAllByRole('gridcell')[7])
      })
