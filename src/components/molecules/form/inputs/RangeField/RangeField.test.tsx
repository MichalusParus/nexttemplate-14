...
describe('RangeField', () => {
  describe('Semantics', () => {
    it('renders RangeInput with Label', () => {
      render(<FieldWithHooks />)

      expect(screen.getByTestId('RangeWrap')).toBeInTheDocument()
    ...
    it('forwards className', () => {
      ...
      expect(screen.getByTestId('RangeWrap')).toHaveClass('className')
    })
    ...
    it('placeholder', () => {
      ...
      expect(screen.getByRole('slider')).toHaveAttribute('placeholder', 'placeholder')
    })
