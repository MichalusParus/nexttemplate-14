...
describe('GridFooter', () => {
  describe('Semantics', () => {
    it('renders footer with pagination, rows-per-page select, and export', () => {
      ...
      const footer = container.querySelector('.GridFooterContent')!

      expect(footer).toBeInTheDocument()
      expect(footer).toHaveClass('GridFooterContent')
  ...
  describe('Ref', () => {
    it('footer container is accessible in DOM', () => {
      const { container } = render(
        <JestDataGridProvider>
          <GridFooter
            filteredData={gridData.slice(0, 25)}
      ...
      expect(container.querySelector('.GridFooter')).toBeInstanceOf(HTMLDivElement)
    })
  })
