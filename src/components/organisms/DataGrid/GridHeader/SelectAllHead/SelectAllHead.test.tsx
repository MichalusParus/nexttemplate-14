...
describe('SelectAllHead', () => {
  describe('Semantics', () => {
    ...
    it('unchecked state — no selected class', () => {
      ...
      expect(screen.getByRole('columnheader').querySelector('button')).not.toHaveClass('selected')
    })
    ...
    it('checked state — selected class', () => {
      ...
      expect(screen.getByRole('columnheader').querySelector('button')).toHaveClass('selected')
    })
