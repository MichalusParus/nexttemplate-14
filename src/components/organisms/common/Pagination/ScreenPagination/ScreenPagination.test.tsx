...
describe('ScreenPagination', () => {
  describe('Semantics', () => {
    ...
    it('selected page has tabIndex={0}, others have tabIndex={-1}', () => {
      ...
      const selectedButton = pageButtons.find(btn => btn.classList.contains('selected'))
      const unselectedButtons = pageButtons.filter(btn => !btn.classList.contains('selected'))
