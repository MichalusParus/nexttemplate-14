...
export type ScrollShadowProps = NativeDivProps & {
  ...
  /** ARIA role for the inner scroll container (e.g. "rowgroup" inside a grid) */
...
export const ScrollShadow = forwardRef<HTMLDivElement | null, ScrollShadowProps>(
  (
    ...
    const {
      ...
      overflow,
      handleScroll,
    } = useScrollShadow(disableHorizontal)
